...
This package provides a framework for distributed deep learning. It includes classes and functions necessary for utilizing MLC-base in your training script.

To use MLC-base, import the package into your training script and utilize the package through the MLC_init() function.
...
def init_MLC(args, **overrides) -> MPI:
    """
    Initialize the MLC environment.
